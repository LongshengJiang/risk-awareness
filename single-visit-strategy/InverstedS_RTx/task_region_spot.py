...
class Region:
    def __init__(self, row=30, col=30):
        ...
        self.prob = np.random.uniform(low=0, high=0.02, size=(row, col))
    ...
    def spot_pattern():
        ...
        prob_pattern[0:2, :] = np.random.uniform(low=0, high=0.02, size=(2, 10))
        prob_pattern[-2:, :] = np.random.uniform(low=0, high=0.02, size=(2, 10))
        prob_pattern[:, 0:2] = np.random.uniform(low=0, high=0.05, size=(10, 2))
        prob_pattern[:, -2:] = np.random.uniform(low=0, high=0.05, size=(10, 2))
        prob_pattern[2:4, 2:8] = np.random.uniform(low=0.05, high=0.1, size=(2, 6))
        prob_pattern[-4:-2, 2:8] = np.random.uniform(low=0.05, high=0.1, size=(2, 6))
        prob_pattern[2:8, 2:4] = np.random.uniform(low=0.1, high=0.15, size=(6, 2))
        prob_pattern[2:8, -4:-2] = np.random.uniform(low=0.1, high=0.15, size=(6, 2))
        prob_pattern[4:6, 4:6] = np.random.uniform(low=0.1, high=0.3, size=(2, 2))
        return prob_pattern
